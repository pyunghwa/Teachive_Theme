...
<?php if ( have_comments() ) : ?>
    <h3 class="comments2"><?php comments_number(__('No Comments'), __('One Comment'), __('% Comments'));?></h3>
...
<?php wp_list_comments(array('avatar_size' => '55', 'callback' => 'paragrams_comments'  )); ?>
