				...
				<div id="profile">
					<?php 
						...
						if ( 0 == $current_user->ID ) {
							// Not logged in.
							?>
							<a href="<?php bloginfo("wpurl"); ?>/wp-login.php">
							<img src="<?php bloginfo('template_url'); ?>/images/login.png" alt="Log in"/></a>
							Log in, please
							<?php
						} else {
							// Logged in.
							echo get_avatar(get_current_user_id(), $size='30');
			...
			<div id="category_bar">
				...
				<?php
				    ...
				    if ( function_exists( 'wp_nav_menu' ) )
				        wp_nav_menu( array( 'theme_location' => 'custom-menu','fallback_cb'=> 'custom_menu','container' => 'ul','depth' => 3,'menu_id' => 'top-menu', ) );
				    else
				        custom_menu();
				?>
				</div>
